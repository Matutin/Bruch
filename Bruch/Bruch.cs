...
namespace Bruchrechner
{
    ...
    public class Bruch
    {
        ...
        {
            int endnenner = nenner * other.nenner;
            int zwischenzaehler1 = zaehler * other.nenner;
            int zwischenzaehler2 = other.zaehler * nenner;
            int endzaehler = zwischenzaehler1 - zwischenzaehler2;

            return new Bruch(endzaehler, endnenner);
        }
